...
const ApartmentPage = () => {
  ...
  const handleSearch = () => {
  console.log("DEBUG TIME VALUES:", apartments.map(a => a.time));
  ...
  const filtered = apartments.filter((item) => {
    ...
    if (selectedPrices.length === 0) {
      ...
      matchPrice = selectedPrices.some((priceRange) => {
        ...
        if (priceRange === "500.000 - 1.000.000 VNĐ") return priceNumber >= 500000 && priceNumber <= 1000000;
      ...
      <Container sx={{ marginBottom: "30px" }}>
        ...
        {filterOn && (
          <div className="relative flex flex-col justify-center items-center w-full">
                ...
                <div className="flex flex-col gap-2">
                  <label className="flex items-center gap-2">
                    <input
                      ...
                      onChange={() => handleCheckboxChange("Phòng đơn", selectedTypes, setSelectedTypes)}
                    />
                    Phòng đơn
                  </label>
                  <label className="flex items-center gap-2">
                    <input
                      type="checkbox"
                      className="form-checkbox"
                      onChange={() => handleCheckboxChange("Phòng đôi", selectedTypes, setSelectedTypes)}
                    />
                    Phòng đôi
                  </label>
                  <label className="flex items-center gap-2">
                    <input
                      type="checkbox"
                      className="form-checkbox"
                      onChange={() => handleCheckboxChange("Phòng tập thể", selectedTypes, setSelectedTypes)}
                    />
                    Phòng tập thể
                  </label>
                </div>
                ...
                <div className="flex flex-col gap-2">
                  <label className="flex items-center gap-2">
                    <input
                      type="checkbox"
                      className="form-checkbox"
                      onChange={() => handleCheckboxChange("Còn trống", selectedStates, setSelectedStates)}
                    />
                    Còn trống
                  </label>
                  <label className="flex items-center gap-2">
                    <input
                      type="checkbox"
                      className="form-checkbox"
                      onChange={() => handleCheckboxChange("Đã đặt", selectedStates, setSelectedStates)}
                    />
                    Đã đặt
                  </label>
                  <label className="flex items-center gap-2">
                    <input
                      type="checkbox"
                      className="form-checkbox"
                      onChange={() => handleCheckboxChange("Sắp trả", selectedStates, setSelectedStates)}
                    />
                    Sắp trả
                  </label>
                </div>
                ...
                <div className="flex flex-col gap-2">
                  <label className="flex items-center gap-2">
                    <input
                      type="checkbox"
                      className="form-checkbox"
                      onChange={() => handleCheckboxChange("1 ngày", selectedTimes, setSelectedTimes)}
                    />
                    1 ngày
                  </label>
                  <label className="flex items-center gap-2">
                    <input
                      type="checkbox"
                      className="form-checkbox"
                      onChange={() => handleCheckboxChange("2 - 7 ngày", selectedTimes, setSelectedTimes)}
                    />
                    2 - 7 ngày
                  </label>
                  <label className="flex items-center gap-2">
                    <input
                      type="checkbox"
                      className="form-checkbox"
                      onChange={() => handleCheckboxChange("Trên 7 ngày", selectedTimes, setSelectedTimes)}
                    />
                    Trên 7 ngày
                  </label>
                </div>
                ...
                <div className="flex flex-col gap-2">
                  <label className="flex items-center gap-2">
                    <input
                      type="checkbox"
                      className="form-checkbox"
                      onChange={() => handleCheckboxChange("Dưới 500.000 VNĐ", selectedPrices, setSelectedPrices)}
                    />
                    Dưới 500.000 VNĐ
                  </label>
                  <label className="flex items-center gap-2">
                    <input
                      type="checkbox"
                      className="form-checkbox"
                      onChange={() => handleCheckboxChange("500.000 - 1.000.000 VNĐ", selectedPrices, setSelectedPrices)}
                    />
                  ...
                  <label className="flex items-center gap-2">
                    <input
                      type="checkbox"
                      className="form-checkbox"
                      onChange={() => handleCheckboxChange("Trên 1.000.000 VNĐ", selectedPrices, setSelectedPrices)}
                    />
                    Trên 1.000.000 VNĐ
                  </label>
                </div>
            ...
            <div style={{ marginTop: "10px", marginBottom: "25px", paddingLeft: "16px" }}>
          <h2 style={{ fontWeight: "bold", fontSize: "30px" }}>Danh sách các phòng</h2>
        </div>
          </div>
        )}
